...
function init() {
    ...
    let guessFields = document.getElementsByClassName("guess");
    ...
    for (let i = 0; i < guessFields.length; i++) {
        ...
        for (let j = 0; j < countries.length; j++) {
            ...
            guessFields[i].appendChild(option);
...
function guess() {
    ...
    if (document.getElementById("g" +  current).value == country) {
...
function displayImage() {
    ...
    if (country == undefined) {
        ...
        alert("Hi. My code has detected an error. If you could please report an issue here (https://github.com/YourNerdiness/yournerdiness.github.io/issues), with the error code 1000" + pictureName.toUpperCase() + ", I would greatly appreciate it");
